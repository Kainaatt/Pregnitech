...
# Load text data
with open("pregnancy_month9.txt", "r", encoding="utf-8") as f:
    data = f.read()
...
chatbot = gr.ChatInterface(
    ...
    type="messages",
    additional_inputs=[
        gr.Textbox(value="You are a friendly Pregnancy 9th month guidance chatbot named 'PREGNITECH' developed by team Helix AI which consists of 3 members: Hashir Ehtisham, Lameea Khan and Kainat Ali.", label="System message"),
